...
public class Account_Thread_Safe implements Runnable {
    String name;
    int balance = 100;
    int withdraw = 0;
    ...
    @Override
    /**Synchronized run() method called
     * Now another thread will execute this method
     * Only when current thread completes executing this method
     */
